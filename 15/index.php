...
<html>
   <head>
		...
		<body>
			...
			<tr>
			  <td id='logo_text'>Весняні квіти</td>
			  <td rowspan="2" class='foto_car'>
			  <?
			 $q=mysql_query("SELECT foto FROM fotoflow WHERE id_menu='$menu'");
			...
			<tr>
			  ...
			  $q=mysql_query("SELECT * FROM menu2");
			  
			  
			  while($row=mysql_fetch_array($q)){
				 echo "<a href='?menu=".$row['id']."'> ".$row['menu']." </a>";
			  }
