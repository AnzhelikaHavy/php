<form action="11-9.php" method="POST">
      <h3>Введіть слово:  </h3>
	  <input type="text" name="str"  >
	  <input type="submit" value=" Дешифратор">
</form>
...
http://host231.itelit.pro/11/11-9.php
 */   
$ukr="йцукенгшщзхїфівапролджєячсмитьбю";
$eng="qwertyuiop[]asdfghjkl;'zxcvbnm,.";

if($_POST){
	$ll=mb_strlen($eng,"UTF-8");	
  $l2=mb_strlen($ukr,"UTF-8");
echo "<h1>Дешифратор</h1>";  
echo $ll."симв.-".$eng."<br>";
echo $l2."симв.-".$ukr."<br>";
...
for($i=0; $i<$l; $i++){
	...
	for($j=0; $j<$ll; $j++){
		$sju=mb_substr($eng,$j,1,"UTF-8");
		if($si==$sju){
			$sje=mb_substr($ukr,$j,1,"UTF-8");
